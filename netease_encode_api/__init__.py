...
class EncodeSession:
    ...
    def __init__(self):
        """self.__encode_arg_e = "010001"
        self.__encode_arg_f = "".join(
            tmp
            for tmp in [
                "00e0b509f6259df8642dbc35662901477df22677ec152b5ff6",
                "8ace615bb7b725152b3ab17a876aea8a5aa76d2e417629ec4e",
                "e341f56135fccf695280104e0312ecbda92557c93870114af6",
                "c9d05c4f7f0c3685b7a46bee255932575cce10b424d813cfe4",
                "875d3e82047b97ddef52741d546b8e289dc6935b3ece0462db",
                "0a22b8e7",
            ]
        )"""
        self.__encode_arg_g = "0CoJUm6Qyw8W8jud"
        self.__encode_arg_i = "vlgPRPyGhwA6F4Sq"
        self.__encode_sec_key = "".join(
            tmp
            for tmp in [
    ...
    def get_response(self, encode_data: dict, url: str = ""):
        """获取资源"""
        processed_data = {
